...
let string = array2.reduce(function(accumulator, currentValue) {
	return accumulator + ' ' + currentValue
});
...
// ​
// // Use nested function to reduce the array.
// let sum = myArray.reduce(function(accumulator, currentValue) {
// 	return accumulator + currentValue;
// });
// console.log("The sum of myArray is " +  sum);
// ​
// ​
// // 2. Turn this array into a string using JavaScript Reduce.
// const trekArray = ["Deflector", "power", "at", "maximum.", "Energy", "discharge", "in", "six", "seconds.", "Warp", "reactor", "core", "primary", "coolant", "failure.", "Fluctuate", "phaser", "resonance", "frequencies.", "Resistance", "is", "futile.", "Recommend", "we", "adjust", "shield", "harmonics", "to", "the", "upper", "EM", "band", "when", "proceeding.", "These", "appear", "to", "be", "some", "kind", "of", "power-wave-guide", "conduits", "which", "allow", "them", "to", "work", "collectively", "as", "they", "perform", "ship", "functions.", "Increase", "deflector", "modulation", "to", "upper", "frequency", "band."];
// ​
// // Declare a separate reducer function abnd use that.
// const concatenateReducer = (text, currentValue) => text + ' ' + currentValue;
// console.log(trekArray.reduce(concatenateReducer));